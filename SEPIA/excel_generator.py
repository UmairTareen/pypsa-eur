...
entry_label_mapping = {
    ...
    'residential rural heat': {'label': 'Residential and tertiary heat demand', 'source': 'TWh', 'target': 'demandheat'},
    'residential urban decentral heat': {'label': 'Residential and tertiary heat demand', 'source': 'TWh', 'target': 'demandheata'},
    'services rural heat': {'label': 'Residential and tertiary heat demand', 'source': 'TWh', 'target': 'demandheatb'},
    'services urban decentral heat': {'label': 'Residential and tertiary heat demand', 'source': 'TWh', 'target': 'demandheatc'},
}
# %%
