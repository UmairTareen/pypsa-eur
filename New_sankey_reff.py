...
fn = f"{PATH}resources/industrial_energy_demand_elec_s_6_2020.csv"
feedstock_emissions = (
...
df.loc[df.label.str.contains("residential urban decentral biomass boiler") & (df.source == "solid biomass"), "source"] = "biomass"
df.loc[df.label.str.contains("residential urban decentral biomass boiler") & (df.target == "urban central heat"), "target"] = "heat"
df.loc[df.label.str.contains("services urban decentral biomass boiler") & (df.source == "solid biomass"), "source"] = "biomass"
...
collection.append(
    pd.Series(dict(label="solid biomass for industry", source="solid biomass", target="co2 atmosphere", value=value*0.37))
)
