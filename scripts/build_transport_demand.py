...
def build_nodal_transport_data(fn, pop_layout):
    transport_datas = pd.read_csv(fn, index_col=0)
...
def build_transport_demand(traffic_fn, airtemp_fn, nodes, nodal_transport_data, config):
